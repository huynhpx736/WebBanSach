...
const CancelledOrdersShipper = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const data = await fetchOrdersByShipperAndStatus(shipperId, 'CANCELLED');
  ...
  return (
    <div className="orders-page">
      <h2>ĐƠN HÀNG THẤT BẠI ĐÃ BỊ HỦY</h2>
...
export default CancelledOrdersShipper;

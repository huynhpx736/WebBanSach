...
// //   return (
// //     <div className="failed-orders-page">
...
// //                 <td>{order.failureReason || 'Không'}</td>
// //                 <td>{order.note || 'Không '}</td>
// //               </tr>
// //             ))}
// //           </tbody>
// //         </table>
...
//     const fetchFailedOrders = async () => {
//       try {
//         const data = await fetchOrdersByShipperAndStatus(shipperId, 'FAILURE');
//         setFailedOrders(data);
//         setFilteredOrders(data); // Hiển thị toàn bộ danh sách mặc định
//       } catch (error) {
//         console.error('Failed to fetch failed orders:', error);
//       }
//     };
...
//   // Hàm lọc đơn hàng theo mã hoặc ngày đặt
//   const handleSearch = () => {

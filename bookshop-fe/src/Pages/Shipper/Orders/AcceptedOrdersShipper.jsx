...
//                   <td>{order.user.fullname}</td>
//                   <td>
//                     <button className="accept-button" onClick={() => handleCompleteOrder(order.id)}>
//                       Giao thành công
//                     </button>
//                     <button className="failure-button" onClick={() => setSelectedOrderId(order.id)}>
//                       Giao thất bại
//                     </button>
//                   </td>
//                 </tr>
...
import { fetchOrdersByShipperAndStatus, updateOrderStatus, reportFailedDelivery } from '../../../api';
import { Link } from 'react-router-dom';
import { MdCheckCircle, MdCancel } from 'react-icons/md'; // Import các biểu tượng
import './ShipperOrders.css';

...
import { fetchAllOrdersByShipper } from '../../../api';
...
const DashboardShipper = () => {
  ...
  const fetchData = async (month, year) => {
    try {
      const orders = await fetchAllOrdersByShipper(shipperId);
      const labels = [];
  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="stats-container">
        ...
        <p><strong>Tổng giá trị đã thu:</strong> {stats.totalRevenue.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</p>

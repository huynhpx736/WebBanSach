...
// const KeyMailJS = 'X5CRJm7kn81DIrO9A'; 
// const KeyServiceMailJS = 'service_zj636ta';
// const KeyTemplateCancel = 'template_g1bu3os'; 
...
//         const data = await getOrderByStatus('FAILED');
//         const sortedData = data.sort(
//           // Sắp xếp đơn hàng theo lý do hủy và ngày đặt
//           (a, b) => {
...
//     // emailjs.init('X5CRJm7kn81DIrO9A');
...
//     //tới email để gửi email cho khách hàng và tạo email với thông tin đơn hàng
...
//     try {
//       await updateOrderStatus(orderId, 'RESCHEDULED');
...
//       setOrders(orders.filter(order => order.id !== selectedOrderId));
//       setFilteredOrders(filteredOrders.filter(order => order.id !== selectedOrderId));
//       alert('Đã huỷ đơn hàng và hoàn kho sách!');
//       setSelectedOrderId(null);
//       setCancelledReason('');
//       setCustomReason('');
//       setNote('');
...
//                         <MdEmail /> Email khách hàng
//                       </button>
//                     )}
//                     {order.failureReason === 'Hoãn giao hàng' && (
...
//                       </button>
//                     )}
//                     <button className="btn-cancel" onClick={() => setSelectedOrderId(order.id)}>
//                       <MdCancel /> Hủy
//                     </button>
//                   </td>
//                 </tr>
...
import React, { useEffect, useState } from 'react';
import { getOrderByStatus, updateOrderStatus, cancelOrderByAdmin, updateAdminNoteOrder } from '../../../api';
import { Link } from 'react-router-dom';
import { MdCheckCircle, MdCancel, MdEmail } from 'react-icons/md';
import emailjs from 'emailjs-com';
import { message } from 'antd';

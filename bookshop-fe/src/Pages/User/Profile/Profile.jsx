...
//     try {
//       const updatedUser = await updateUser(userId, { 'avatar':avatar, 'fullname':fullname,'username':user.username, 'email': email, 'role':1,'password':oldPassword, 'phone':phone });
//       setUser(updatedUser);
...
//               <p><strong>Loại:</strong> {user.classification}</p>
...
//             />
//             <button onClick={handleChangePassword} className="forgot-password-btn">Lưu mật khẩu</button>

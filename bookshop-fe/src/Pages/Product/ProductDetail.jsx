...
// import React, { useEffect, useState } from 'react';
// import { useParams } from 'react-router-dom';
// import { fetchProductById, fetchProductsByCategory, fetchAllProducts } from '../../api';
...
//         // Lấy sản phẩm liên quan dựa trên thể loại
...
//         } else {
//           // Nếu không có thể loại, lấy tất cả sản phẩm
//           fetchAllProducts()
//             .then(products => setRelatedProducts(products))
//             .catch(err => console.error('Failed to fetch all products.', err));
//         }

//         // Fetch comments nếu có endpoint
